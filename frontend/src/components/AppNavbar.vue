      ...
      >
        ...
        >
          ...
          >
            ...
            <router-link to="/bookings" class="px-4 py-2 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-[#4A0004] transition flex items-center space-x-2">
              <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
              <span>My Bookings</span>
            </router-link>
            
            <router-link to="/saved" class="px-4 py-2 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-[#4A0004] transition flex items-center space-x-2">
            ...
            <router-link to="/settings" class="px-4 py-2 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-[#4A0004] transition flex items-center space-x-2">
